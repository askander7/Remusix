...
namespace RemusixWeb.Controllers
{
    public class AlbumsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AlbumID,AlbumName,YearOfProduction,Plays,Rating,AlbumDescription,ArtistID")] Album album)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AlbumID,AlbumName,YearOfProduction,Plays,Rating,AlbumDescription,ArtistID")] Album album)
        {
            if (ModelState.IsValid)
            {
