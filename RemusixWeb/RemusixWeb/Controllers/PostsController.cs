...
namespace RemusixWeb.Controllers
{
    public class PostsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "PostID,PostContent,PostTime,UserID")] Post post)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "PostID,PostContent,PostTime,UserID")] Post post)
        {
            if (ModelState.IsValid)
            {
